...
def generate_image(encoder, decoder, detokenizer, tokenizer, prompt, temperature=0.3, top_k=160, supercondition_factor=8):
    """生成单张图像"""
...
def filter_training_images():
    ...
    for img_path in image_files:
        try:
            ...
            # 简单的质量评估，降低阈值
            if evaluate_image_quality(img) > 0.2:  # 降低阈值
